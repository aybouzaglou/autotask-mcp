...
async function main() {
    ...
    const create = tools.filter((t) => t.annotations?.readOnlyHint === false && t.name.includes('create'));
    const update = tools.filter((t) => t.annotations?.readOnlyHint === false && t.name.includes('update'));
